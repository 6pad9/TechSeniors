Feature: Preguntas rápidas para el cuidador
  ...
  Scenario: El cuidador busca preguntas frecuentes para su rol
    ...
    Then Se le brinda preguntas frecuentes con sus respectivas respuestas
    And Las preguntas están actualizadas regularmente para cubrir temas nuevos y comunes
